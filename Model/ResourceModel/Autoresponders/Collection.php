...
namespace Licentia\Panda\Model\ResourceModel\Autoresponders;

/**
 * Class Collection
 *
 * @package Licentia\Panda\Model\ResourceModel\Autoresponders
 */
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    protected function _construct()
    {
        ...
        parent::_construct();
        $this->_init(\Licentia\Panda\Model\Autoresponders::class,
            \Licentia\Panda\Model\ResourceModel\Autoresponders::class);
    ...
    public function _initSelect()
    {
        ...
        $this->getSelect()
             ->joinLeft(
                 ...
                 "td.entity_id = main_table.autoresponder_id AND td.entity_type='autoresponders'",
                 []
             )
             ->joinLeft(
             ...
             ->group('main_table.autoresponder_id');
