 ...
 */
class Splits extends \Magento\Backend\App\Action
{

    /**
     * Authorization level of a basic admin session
     */
    const ADMIN_RESOURCE = 'Licentia_Panda::splits';
    ...
    public function execute()
    {
        ...
        $model = $this->splitsFactory->create();
        ...
        $this->registry->register('panda_split', $model, true);
    }
