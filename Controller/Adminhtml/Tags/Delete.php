 ...
 */
class Delete extends \Licentia\Panda\Controller\Adminhtml\Tags
{
        ...
        if ($model->getId()) {
            try {
                ...
                $this->messageManager->addExceptionMessage(
                    $e,
                    __('Something went wrong while deleting the tag.')
                );
            }

            return $resultRedirect->setPath('*/*/edit', ['id' => $model->getId()]);
        } else {
            $this->messageManager->addErrorMessage(__('We can\'t find an Tag to delete.'));
        }
