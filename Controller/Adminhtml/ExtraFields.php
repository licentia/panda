 ...
 */
class ExtraFields extends \Magento\Backend\App\Action
{

    /**
     * Authorization level of a basic admin session
     */
    const ADMIN_RESOURCE = 'Licentia_Panda::extra';
    ...
    public function execute()
    {
        ...
        $model = $this->extraFieldsFactory->create();
        ...
        $this->registry->register('panda_extra', $model, true);
    }
